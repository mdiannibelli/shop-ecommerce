                        ...
                        <div className="tabs mt-3">
                            <ul className='nav nav-tabs' id='myTab' role='tablist'>
                                <li className='nav-item' role='presentation'><a className={`nav-link ${activeTab === "visa" ? "active" : ""}`}
                                 href="#visa" id='visa-tab' data-toggle="tab" role='tab' aria-controls='visa' aria-selected={activeTab === "visa"} onClick={() => handleTabChanges("visa")}><img src="https://i.imgur.com/sB4jftM.png" alt="" width="80" /></a></li>
                                <li className='nav-item' role='presentation'><a className={`nav-link ${activeTab === "paypal" ? "active" : ""}`}
                                 href="#paypal" id='paypal-tab' data-toggle="tab" role='tab' aria-controls='paypal' aria-selected={activeTab === "paypal"} onClick={() => handleTabChanges("paypal")}><img src="https://i.imgur.com/yK7EDD1.png" alt="" width="80" /></a></li>
                            </ul>
                                ...
                                >
                                    ...
                                    <div className='mt-4 mx-4'>
                                        ...
                                        <div className='form mt-3'>
                                            ...
                                            <div>
                                            <p className='mt-2 p-Disclaimer'><em>Payment Disclaimer: In no event shall payment or partial payment by Owner for any material or service</em></p>
                                            </div>
